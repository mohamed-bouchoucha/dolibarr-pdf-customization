...
class pdf_onrnegoce_propale extends ModelePDFPropales
{
    ...
    protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
    {
        ...
        $pdf->SetFont('', 'B', 14);
        $pdf->SetXY(10, 60);
        $pdf->MultiCell(100, 5, $outputlangs->trans("Proposal")." : ".$object->ref, 0, 'L');
    }

    protected function _pagefoot(&$pdf, $object, $outputlangs)
    {
        return pdf_pagefoot($pdf, $outputlangs, 'PROPALE_FREE_TEXT', $this->emetteur, 10, 10, $this->page_largeur, $object);
    }
}
