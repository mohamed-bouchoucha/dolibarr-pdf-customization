...
class pdf_onrnegoce_propale extends ModelePDFPropales
{
    ...
    public function __construct($db)
    {
        global $langs;
        $this->db = $db;
        $this->description = "Modèle Premium ONR Négoce pour Devis";
    ...
    protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs) 
    {
        ...
        $pdf->MultiCell(70, 8, "DEVIS ".$object->ref, 0, 'C', 1);
    ...
    protected function _extrafieldsBlock(&$pdf, $object, $outputlangs)
    {
        ...
        if (!empty($val_ref_cmd)) {
            ...
            $pdf->SetFont('', '', 9); $pdf->SetX(10); $pdf->SetFont('', 'B'); $pdf->Cell(40, 5, "Réf Commande :"); $pdf->SetFont('', ''); $pdf->Cell(50, 5, $val_ref_cmd, 0, 1);
        }
    }

    protected function _signatureBlock(&$pdf, $object, $outputlangs)
    {
        // Pour les devis, on affiche toujours le bloc signature
        ...
        $pdf->SetXY(10, $pdf->GetY() + 22); $pdf->SetFont('', '', 8); $pdf->Cell(90, 5, "Date : .... / .... / 20....", 0, 0);
    }
    ...
    protected function _pagefoot(&$pdf, $object, $outputlangs)
    {
        ...
        $pdf->MultiCell(0, 4, $mysoc->name." - CP : ".$mysoc->zip." ".$mysoc->town." - SIREN : ".$mysoc->idprof1, 0, 'C');
