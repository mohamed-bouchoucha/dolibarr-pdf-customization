...
/**
 * Class pdf_onrnegoce_livraison
 * Modèle Premium ONR Négoce pour Bons de Livraison
 */
class pdf_onrnegoce_livraison extends ModelePdfExpedition
{
    ...
    public function __construct($db)
    {
        ...
        $this->description = "Modèle Premium ONR Négoce pour Bons de Livraison";
    ...
    public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
    {
        ...
        // --- CODE-BARRES ET INFOS LOGISTIQUES ---
        $pdf->SetFillColor(245, 247, 250);
        $pdf->Rect(10, $curY, 190, 25, 'F');
        
        $pdf->SetXY(15, $curY + 3);
        $pdf->SetFont('', 'B', 10); $pdf->Cell(100, 5, "Date : ".dol_print_date($object->date_delivery, 'day'), 0, 1);
        $pdf->SetFont('', '', 9); 
        $pdf->SetX(15); $pdf->Cell(100, 5, "Commande : ".$object->origin_ref, 0, 1);
        if ($object->trueWeight > 0) {
            $pdf->SetX(15); $pdf->Cell(100, 5, "Poids Estimé : ".$object->trueWeight." kg", 0, 1);
        }
        ...
        $pdf->write1DBarcode($object->ref, 'C128', 125, $curY + 3, 70, 18, 0.4, $style, 'N');
        ...
        foreach ($object->lines as $line) {
            ...
            if ($fill) {
                $pdf->SetFillColor(245, 247, 250);
                $pdf->Rect($col1, $startY, 190, $lineHeight, 'F');
            }
    ...
    protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs) 
    {
        ...
        $pdf->MultiCell(70, 8, "LIVRAISON ".$object->ref, 0, 'C', 1);
    ...
    protected function _pagefoot(&$pdf, $object, $outputlangs)
    {
        ...
        $pdf->MultiCell(0, 4, $mysoc->name." - BL Logistique - Ne peut servir de facture", 0, 'C');
    ...
    protected function _signatureBlock(&$pdf, $object, $outputlangs)
    {
        ...
        $pdf->Cell(95, 5, "Visa Client (Nom + Signature)", 0, 0, 'L');
        $pdf->Cell(95, 5, "Visa Chauffeur / Entrepôt", 0, 1, 'L');
