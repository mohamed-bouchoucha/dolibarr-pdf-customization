...
/**
 *  \file       custom/pdfcustom/core/modules/expedition/doc/pdf_onrnegoce_expedition.modules.php
 *  \ingroup    expedition
 *  \brief      Modèle d'expédition personnalisé ONR Negoce
 */
...
class pdf_onrnegoce_expedition extends ModelePdfExpedition
{
    ...
    public function __construct($db)
    {
        global $langs;
        $this->db = $db;
        $this->name = "onrnegoce_expedition";
        $this->description = "Modèle PDF ONR Négoce pour Expéditions";
    ...
    protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
    {
        ...
        $pdf->SetFont('', 'B', 14);
        $pdf->SetXY(10, 60);
        $pdf->MultiCell(100, 5, $outputlangs->trans("Sending")." : ".$object->ref, 0, 'L');
    }

    protected function _pagefoot(&$pdf, $object, $outputlangs)
    {
        return pdf_pagefoot($pdf, $outputlangs, 'SENDING_FREE_TEXT', $this->emetteur, 10, 10, $this->page_largeur, $object);
    }
}
